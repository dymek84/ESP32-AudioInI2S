inline float full_spectrum_frequencies[64] = { 50.0,    150.79,  251.59,  352.38,  453.17,  553.97,  654.76,  755.56,  856.35,  957.14,  1057.94, 1158.73, 1259.52, 1360.32, 1461.11, 1561.90, 1662.70, 1763.49, 1864.29, 1965.08, 2065.87, 2166.67, 2267.46, 2368.25, 2469.05, 2569.84, 2670.63, 2771.43, 2872.22, 2973.02, 3073.81, 3174.60,
                                               3275.40, 3376.19, 3476.98, 3577.78, 3678.57, 3779.37, 3880.16, 3980.95, 4081.75, 4182.54, 4283.33, 4384.13, 4484.92, 4585.71, 4686.51, 4787.30, 4888.10, 4988.89, 5089.68, 5190.48, 5291.27, 5392.06, 5492.86, 5593.65, 5694.44, 5795.24, 5896.03, 5996.83, 6097.62, 6198.41, 6299.21, 6400.0 };

inline float window_lookup[4096];

inline freq frequencies_musical[BAND_SIZE];
inline uint16_t max_goertzel_block_size = 0;

inline volatile bool magnitudes_locked = false;

inline float spectrogram[BAND_SIZE];
inline float chromagram[12];

inline float spectrogram_smooth[BAND_SIZE] = { 0.0 };
inline float spectrogram_average[12][BAND_SIZE];
inline uint8_t spectrogram_average_index = 0;
...
inline void init_goertzel_constants_musical()
{
    for (uint16_t i = 0; i < BAND_SIZE; i++)
    {
        // INIT MUSICAL FREQS
        ...
        float neighbor_distance_hz = max(fabs(frequencies_musical[i].target_freq - neighbor_left), fabs(frequencies_musical[i].target_freq - neighbor_right));
...
inline float find_median(float *data, int size)
{
    float temp;
...
inline void median_filter(float *spectrogram_column)
{
    ...
    for (int i = 0; i < BAND_SIZE; i++)
    {
        ...
        for (int j = 0; j < FILTER_SIZE; j++)
        {
            ...
            index = index < 0 ? 0 : (index >= BAND_SIZE ? BAND_SIZE - 1 : index);
...
inline float calculate_magnitude_of_bin(uint16_t bin_number, float *sample_history, uint16_t SAMPLE_HISTORY_LENGTH)
{
    ...
    // {
    //     // min_max2->update(luma_output_array[i]);
    //     int val = sample_ptr[i]*10 ;
    //     Serial.print("[");
    //     Serial.print(val);
    //     Serial.print("]");
    //     for (int j = 0; j < val; j++)
    ...
    float progress = float(bin_number) / BAND_SIZE;
    progress *= progress;
    progress *= progress;
...
inline void calculate_magnitudes(float *sample_history, uint16_t SAMPLE_HISTORY_LENGTH)
{
    ...
    static float magnitudes_raw[BAND_SIZE];
    static float magnitudes_avg[NUM_AVERAGE_SAMPLES][BAND_SIZE];
    static float magnitudes_smooth[BAND_SIZE];
    ...
    for (uint16_t i = 0; i < BAND_SIZE; i++)
    {
        ...
        if (interlace_line == interlacing_frame_field)
        {
            ...
            magnitudes_raw[i] = calculate_magnitude_of_bin(i, sample_history, SAMPLE_HISTORY_LENGTH); // fast_mode enabled (downsampled audio)
        }
...
inline void get_chromagram()
{
    ...
    for (int i = 0; i < 64; i++)
    {
        // fftCalc[i] = frequencies_musical[i].magnitude * 255;
        // fftCalc[i] = frequencies_musical[i].magnitude - (float)squelch * (float)linearNoise[i] / 4.0 <= 0 ? 0 : fftCalc[i];
    }
}